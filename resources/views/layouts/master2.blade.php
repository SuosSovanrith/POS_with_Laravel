  ...
  <body>
    ...
    <aside class="sidebar-nav-wrapper">
      <div class="navbar-logo">
        <a href="/ecommerce/shop" >
          <img src="{{ asset('assets/images/logo/logo-icon-big.svg') }}" alt="logo" width="30" style="display:inline;"/> 
          <h6 style="display:inline;" class="align-middle">POS Ecommerce</h6>
        </a>
      </div>
      <nav class="sidebar-nav">
        <ul>
            <li class="nav-item @yield('sidebar_shop')">
                <a href="/ecommerce/shop">
              ...
              {{-- <li class="nav-item @yield('sidebar_profile')">
                <a href="/ecommerce/profile">
                  <span class="icon" style="width:20px; height:20px;">
              ...
              <div class="header-right">
                ...
                <div class="profile-box ml-15">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    ...
                    <li>
                      <a href="/ecommerce/orders"> <i class="lni lni-clipboard"></i> Order </a>
                    </li>
                    <li class="divider"></li>
                    <li>
