  ...
  <body>
    ...
    <aside class="sidebar-nav-wrapper">
      <div class="navbar-logo">
        <a href="/admin/index" >
          <img src="{{ asset('assets/images/logo/logo-icon-big.svg') }}" alt="logo" width="30" style="display:inline;"/> 
          <h6 style="display:inline;" class="align-middle">POS Management</h6>
        </a>
      </div>
      <nav class="sidebar-nav">
        <ul>
        <li class="nav-item @yield('sidebar_dashboard')">
            <a href="/admin/index">
            <span class="icon">
          ...
          <li class="nav-item nav-item-has-children @yield('sidebar_people')">
            <a
              href="#0"
              class="collapsed"
            ...
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              <li class="nav-item @yield('sidebar_users')">
                <a href="/admin/users">
                  <span class="icon" style="width:20px; height:20px;">
              ...
              <li class="nav-item @yield('sidebar_position')">
          ...
          <li class="nav-item nav-item-has-children @yield('sidebar_products')">
            <a
            href="#0"
            class="collapsed"
            data-bs-toggle="collapse"
            ...
            <ul id="ddmenu_3" class="collapse dropdown-nav">
              ...
              <li class="nav-item @yield('sidebar_category')">
          ...
          <li class="nav-item nav-item-has-children @yield('sidebar_orders')">
            <a
            href="#0"
            class="collapsed"
            data-bs-toggle="collapse"
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    <li>
                      <div class="author-info flex items-center !p-1">
                        <div class="image">
                          <img src="{{ asset(session('photo')) }}" alt="image">
                        </div>
                        <div class="content">
                          <h4 class="text-sm">{{session('name')}}</h4>
                          <a class="text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white text-xs" href="#">{{session('email')}}</a>
                        </div>
                      </div>
                    </li>
                    <li class="divider"></li>
                    ...
                    <li class="divider"></li>
                    <li>
                      <a href="/logout" class="text-danger"> <i class="lni lni-exit"></i> Sign Out </a>
                    </li>
                  </ul>
                </div>
                <!-- profile end -->
